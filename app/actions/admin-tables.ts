...
export async function getFormatTypes(): Promise<FormatType[]> {
  const { data, error } = await supabaseAdmin.from('format_types').select('id, name, description').order('id')
...
export async function addFormatType(name: string, description?: string): Promise<void> {
...
export async function updateFormatType(id: number, name: string, description?: string): Promise<void> {
...
export async function getBindingTypes(): Promise<BindingType[]> {
  const { data, error } = await supabaseAdmin.from('binding_types').select('id, name, description').order('id')
...
export async function addBindingType(name: string, description?: string): Promise<void> {
...
export async function updateBindingType(id: number, name: string, description?: string): Promise<void> {
  const { error } = await supabaseAdmin
    .from('binding_types')
    .update({ name, description })
    .eq('id', id)
...
export async function getImageTypes() {
  const { data, error } = await supabaseAdmin.from('image_types').select('id, name, description').order('id')
...
export async function getBookGenres() {
  const { data, error } = await supabaseAdmin.from('book_genres').select('id, name, description').order('id')
...
export async function getRoles() {
  const { data, error } = await supabaseAdmin.from('roles').select('id, name, description').order('id')
