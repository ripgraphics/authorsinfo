    ...
    <PageContainer>
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mb-4">
            Generate activities for authors, books, publishers, users and groups in the database. This is useful for:
          </p>
          ...
          <div className="p-4 bg-amber-50 border border-amber-200 rounded-md mb-6">
            ...
            <p className="text-amber-700 text-sm">
              This tool will generate appropriate activities for entities in the database. 
              New records will automatically have activities created via database triggers.
              Use this tool to generate activities for existing data or if you need to regenerate activities.
            </p>
          </div>
