    ...
    <div className="container mx-auto p-4 max-w-2xl">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Link existing Cloudinary images to books as cover images. Enter the book ID and
            Cloudinary public ID to establish the connection.
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <div className="space-y-2">
              ...
              {imagePreview && (
                <div className="p-3 bg-blue-50 border border-blue-200 rounded-md">
                  ...
                  <div className="relative h-32 w-full overflow-hidden rounded-sm border">
                    <NextImage
                      src={imagePreview}
                      alt="Preview"
                      fill
                  ...
                  <p className="text-xs text-red-600" hidden={!imagePreviewError}>
                    Image not found or invalid public ID
                  </p>
                </div>
              )}
            </div>
        ...
        <CardContent className="space-y-3 text-sm">
          <div>
            ...
            <ol className="list-decimal list-inside space-y-1 mt-2">
              <li>
                Enter the book's UUID in the Book ID field - the page will automatically fetch and
                display the book title
              </li>
              <li>
                Enter the Cloudinary public ID in the Cloudinary Public ID field - a preview of the
                image will be shown
              </li>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 mt-2">
              <li>
                <strong>Book ID:</strong> bd68ee0c-155b-4ea7-8903-2485e0be5ff1
              </li>
              <li>
                <strong>Cloudinary Public ID:</strong> lr4ahfk9crt7qtgsisa5
              </li>
            </ul>
          </div>
          <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-md">
            <p className="text-yellow-800 text-xs">
              <strong>Note:</strong> This will create or reuse an image record in the database and
              update the book's cover_image_id and original_image_url fields.
            </p>
          </div>
        </CardContent>
      </Card>
