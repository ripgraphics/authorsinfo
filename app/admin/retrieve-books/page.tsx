  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Link href="/admin/new-books" className="border rounded-lg p-6 hover:bg-gray-100">
        ...
        <Link href="/admin/fetch-by-title" className="border rounded-lg p-6 hover:bg-gray-100">
        ...
        <Link href="/admin/fetch-by-year" className="border rounded-lg p-6 hover:bg-gray-100">
