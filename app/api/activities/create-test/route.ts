    ...
    const { data: activity, error } = await supabaseAdmin
      ...
      .insert({
        ...
        data: {
          ...
          shelf: 'Want to Read',
          rating: 5,
          review: 'Excited to read this classic American novel! I\'ve heard great things about the story and the writing style. Looking forward to diving into the world of Jay Gatsby and the Jazz Age.',
