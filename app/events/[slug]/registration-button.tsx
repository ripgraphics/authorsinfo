...
export default function EventRegistrationButton({ 
  ...
  if (isLoading) {
    return (
      <button
        className="inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-gray-400 cursor-not-allowed"
        disabled
      >
  ...
  if (!isActive) {
    return (
      <button
        className="inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-gray-500 cursor-not-allowed"
        disabled
      >
        {status === 'not-open' ? (
          <>
