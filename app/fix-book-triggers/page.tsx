      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <Alert>
            ...
            <AlertDescription>
              This page helps fix the "column role does not exist" error that occurs when updating books.
              The error is caused by database triggers that reference a non-existent role column.
            </AlertDescription>
          </Alert>

          <div className="space-y-4">
            <Button 
              onClick={testBookUpdate} 
              disabled={loading}
              className="w-full"
            >
              {loading ? (
