          ...
          >
            <div className="flex items-start justify-between mb-4">
              ...
              <span className={`px-3 py-1 rounded-full text-sm ${
                event.events.status === 'upcoming' ? 'bg-green-100 text-green-800' :
                event.events.status === 'ongoing' ? 'bg-blue-100 text-blue-800' :
            ...
            <div className="space-y-2 mb-4">
              ...
              <p className="text-sm text-gray-600">
                Format: {event.events.format}
              </p>
              {event.events.virtual_meeting_url && (
                <p className="text-sm text-blue-600">
                  <a href={event.events.virtual_meeting_url} target="_blank" rel="noopener noreferrer">
