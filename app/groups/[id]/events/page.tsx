          ...
          <tbody>
            {events.map(ev => (
              <tr key={ev.event_id || ev.event?.id} className="border-t">
                ...
                <td className="p-2">{ev.event?.start_date ? new Date(ev.event.start_date).toLocaleString() : ""}</td>
                <td className="p-2">{ev.event?.end_date ? new Date(ev.event.end_date).toLocaleString() : ""}</td>
              </tr>
            ))}
          </tbody>
        </table>
