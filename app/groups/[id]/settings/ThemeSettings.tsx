  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        {/* Custom Theme Colors */}
        <div>
          <h4 className="text-md font-medium text-gray-700 mb-3">Custom Theme Colors</h4>
              ...
              <div key={key}>
                ...
                <div className="flex gap-2">
                  <input
                    type="color"
                    value={
                      settings.custom_theme[key as keyof typeof settings.custom_theme] || '#000000'
                    }
      ...
      {!isAdmin && (
        <p className="text-sm text-gray-500 italic">Only group admins can modify theme settings</p>
      )}
    </div>
  )
}
