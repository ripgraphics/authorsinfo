...
function getMockUsers() {
  const mockUsers = []
  const names = [
    "Emma Thompson", "Liam Johnson", "Olivia Martinez", "Noah Williams", "Ava Brown",
    "Elijah Jones", "Sophia Garcia", "William Miller", "Isabella Davis", "James Wilson",
    "Charlotte Rodriguez", "Benjamin Martinez", "Amelia Anderson", "Lucas Taylor", "Mia Thomas",
    "Henry Jackson", "Harper White", "Alexander Harris", "Evelyn Martin", "Daniel Thompson",
    "Abigail Moore", "Matthew Walker", "Emily Clark", "Michael Rodriguez", "Elizabeth Lewis",
    "Sebastian Hall", "Scarlett Allen", "Jack Young", "Madison Hernandez", "Samuel King"
  ]
