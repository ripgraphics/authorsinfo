...
export default function ReadingChallengePage() {
  ...
  return (
    <div className="space-y-6">
      <div className="py-6">
        <h1 className="text-3xl font-bold tracking-tight">{currentYear} Reading Challenge</h1>
        <p className="text-muted-foreground mt-2">Track your reading goals for the year</p>
      </div>
