      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        {events.length === 0 && (
          <div className="text-center py-12">
            ...
            <Link 
              href="/events/create" 
              className="mt-4 inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-xs text-sm font-medium text-white bg-blue-600 hover:bg-blue-700"
            >
              Create an Event
            </Link>
          </div>
