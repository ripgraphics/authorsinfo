...
import { Bell, BookOpen, Menu, MessageSquare, Search, User, Users, LogOut, Lock, UserPlus, Calendar, Settings, BarChart3 } from "lucide-react"
    ...
    >
      <div className="container mx-auto flex h-16 items-center justify-between px-4 max-w-7xl">
        ...
        <div className="page-header__actions flex items-center gap-2">
          ...
          <Button variant="ghost" size="icon" className="page-header__search-btn hidden sm:flex rounded-full" onClick={() => setSearchOpen(true)}>
          ...
          <Button variant="ghost" size="icon" className="page-header__messages-btn hidden sm:flex rounded-full">
          ...
          <Button variant="ghost" size="icon" className="page-header__menu-btn rounded-md md:hidden" onClick={() => setMobileMenuOpen(true)}>
                ...
                <div className="mt-4 border-t pt-4">
                  <div className="flex flex-col gap-2">
                    <Button variant="ghost" asChild className="w-full justify-start">
                      <Link href={getProfileUrlFromUser(user)} onClick={() => setMobileMenuOpen(false)}>
                        <User className="mr-2 h-4 w-4" />
                        Profile
                      </Link>
                    </Button>
