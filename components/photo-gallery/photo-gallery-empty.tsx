...
export function PhotoGalleryEmpty({ isEditable, onUpload }: PhotoGalleryEmptyProps) {
  return (
    <div className="photo-gallery__empty flex flex-col items-center justify-center p-8 text-center">
      ...
      <h3 className="photo-gallery__empty-title text-xl font-semibold mb-2">No Photos Yet</h3>
