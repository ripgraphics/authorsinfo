  ...
  return (
    ...
    >
      {tabs.map((tab) => (
        <button
          key={tab.id}
          className={`entity-tab inline-flex items-center justify-center whitespace-nowrap px-3 py-1.5 text-sm font-medium h-12 transition-colors ${activeTab === tab.id ? 'border-b-2 border-app-theme-blue' : ''} ${tab.disabled ? 'opacity-50 cursor-not-allowed' : ''} hover:!bg-app-theme-blue hover:!opacity-100 hover:text-white`}
