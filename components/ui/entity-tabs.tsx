        ...
        >
          {tabs.map((tab) => (
            <button
              ...
              role="tab"
              className={`flex-shrink-0 flex items-center justify-center gap-2 px-3 py-1.5 text-sm font-medium h-12 min-w-[90px] whitespace-nowrap transition-colors ${
                activeTab === tab.id
                  ? 'bg-app-theme-blue text-primary-foreground border-b-2 border-app-theme-blue'
