      ...
      <div className={`horizontal-scroller-mobile relative w-full ${className}`}>
        {showChevrons && (
          <>
            ...
            <div
              className={`absolute left-[calc(2rem-1px)] top-0 h-12 w-4 bg-gradient-to-r from-black/80 via-black/40 to-transparent pointer-events-none z-10 transition-opacity duration-300 ${
            ...
            <div
              className={`absolute right-[calc(2rem-1px)] top-0 h-12 w-4 bg-gradient-to-l from-black/80 via-black/40 to-transparent pointer-events-none z-10 transition-opacity duration-300 ${
