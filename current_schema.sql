...
CREATE TABLE IF NOT EXISTS "public"."photo_albums" (
    ...
    CONSTRAINT "valid_entity_type" CHECK ((("entity_type" IS NULL) OR (("entity_type")::"text" = ANY (ARRAY[('user'::character varying)::"text", ('publisher'::character varying)::"text", ('author'::character varying)::"text", ('group'::character varying)::"text"])))),
