...
CREATE OR REPLACE FUNCTION "public"."get_user_feed_activities"("p_user_id" "uuid", "p_limit" integer DEFAULT 50, "p_offset" integer DEFAULT 0) RETURNS TABLE("id" "uuid", "user_id" "uuid", "user_name" character varying, "user_avatar_url" character varying, "activity_type" "text", "data" "jsonb", "created_at" timestamp with time zone, "is_public" boolean, "like_count" integer, "comment_count" integer, "is_liked" boolean, "entity_type" "text", "entity_id" "text", "content_type" "text", "image_url" "text", "text" "text", "visibility" "text", "content_summary" "text", "link_url" "text", "hashtags" "text"[], "share_count" integer, "view_count" integer, "engagement_score" numeric, "metadata" "jsonb")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
...
COMMENT ON COLUMN "public"."activities"."content_type" IS 'Type of content: text, image, video, link, etc.';



COMMENT ON COLUMN "public"."activities"."visibility" IS 'Privacy level: public, friends, private, etc.';
...
COMMENT ON COLUMN "public"."activities"."text" IS 'The actual text content of the post';



COMMENT ON COLUMN "public"."activities"."image_url" IS 'URL of attached image if any';
...
COMMENT ON COLUMN "public"."activities"."link_url" IS 'URL of attached link if any';
