...
export async function generateAuthorActivities(authorId: string, adminUserId: string): Promise<boolean> {
  try {
    // Get author data
...
export async function generateBookActivities(bookId: string, adminUserId: string): Promise<boolean> {
  try {
    // Get book data
...
export async function generatePublisherActivities(publisherId: string, adminUserId: string): Promise<boolean> {
  try {
    // Get publisher data
...
export async function generateUserProfileActivities(userId: string, adminUserId: string): Promise<boolean> {
  try {
...
export async function generateGroupActivities(groupId: string, adminUserId: string): Promise<boolean> {
  try {
    // Get group data
...
export async function generateAllAuthorActivities(adminUserId: string): Promise<{ success: boolean, count: number }> {
  try {
    // Get all authors
...
export async function generateAllBookActivities(adminUserId: string): Promise<{ success: boolean, count: number }> {
  try {
    // Get all books
    const { data: books, error: booksError } = await supabaseAdmin
      .from("books")
...
export async function generateAllPublisherActivities(adminUserId: string): Promise<{ success: boolean, count: number }> {
  try {
    // Get all publishers
...
export async function generateAllUserProfileActivities(adminUserId: string): Promise<{ success: boolean, count: number }> {
  try {
...
export async function generateAllGroupActivities(adminUserId: string): Promise<{ success: boolean, count: number }> {
  try {
    // Get all groups
...
export async function generateAllActivities(adminUserId: string): Promise<{ 
  ...
  try {
    ...
    return {
      success: authorResult.success && bookResult.success && publisherResult.success 
              && userProfileResult.success && groupResult.success,
      counts: {
