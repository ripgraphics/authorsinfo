-- Direct fix for RLS policies - run this directly in your database
-- This will allow users to create posts immediately

-- Drop the problematic policies that only allow service_role
