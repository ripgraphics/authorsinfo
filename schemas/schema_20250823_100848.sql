...
CREATE OR REPLACE FUNCTION "public"."calculate_comment_depth"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."calculate_comment_depth"() OWNER TO "postgres";
...
BEGIN
    ...
    WHERE act.entity_type = p_entity_type 
      AND act.entity_id = p_entity_id
...
COMMENT ON FUNCTION "public"."get_entity_timeline_activities"("p_entity_type" "text", "p_entity_id" "uuid", "p_limit" integer, "p_offset" integer) IS 'Get timeline activities for a specific entity with enterprise features. Returns activities in the format expected by the frontend components.';
...
COMMENT ON FUNCTION "public"."get_user_feed_activities"("p_user_id" "uuid", "p_limit" integer, "p_offset" integer) IS 'Get user-specific feed activities with enterprise features. Returns activities in the format expected by the frontend components.';
...
CREATE OR REPLACE FUNCTION "public"."update_comment_thread_id"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  IF NEW.parent_comment_id IS NULL THEN
...
ALTER FUNCTION "public"."update_comment_thread_id"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."activities" (
    ...
    CONSTRAINT "check_bookmark_count_positive" CHECK (("bookmark_count" >= 0)),
...
COMMENT ON COLUMN "public"."book_club_discussion_comments"."parent_comment_id" IS 'Reference to parent comment for nested replies';



COMMENT ON COLUMN "public"."book_club_discussion_comments"."comment_depth" IS 'Depth level of comment in thread (0 = top level)';



COMMENT ON COLUMN "public"."book_club_discussion_comments"."thread_id" IS 'Unique identifier for comment thread';



COMMENT ON COLUMN "public"."book_club_discussion_comments"."reply_count" IS 'Number of direct replies to this comment';
...
COMMENT ON COLUMN "public"."comments"."parent_comment_id" IS 'Reference to parent comment for nested replies';



COMMENT ON COLUMN "public"."comments"."comment_depth" IS 'Depth level of comment in thread (0 = top level)';



COMMENT ON COLUMN "public"."comments"."thread_id" IS 'Unique identifier for comment thread';



COMMENT ON COLUMN "public"."comments"."reply_count" IS 'Number of direct replies to this comment';
...
COMMENT ON COLUMN "public"."discussion_comments"."parent_comment_id" IS 'Reference to parent comment for nested replies';



COMMENT ON COLUMN "public"."discussion_comments"."comment_depth" IS 'Depth level of comment in thread (0 = top level)';



COMMENT ON COLUMN "public"."discussion_comments"."thread_id" IS 'Unique identifier for comment thread';



COMMENT ON COLUMN "public"."discussion_comments"."reply_count" IS 'Number of direct replies to this comment';
...
COMMENT ON COLUMN "public"."event_comments"."parent_comment_id" IS 'Reference to parent comment for nested replies';



COMMENT ON COLUMN "public"."event_comments"."comment_depth" IS 'Depth level of comment in thread (0 = top level)';



COMMENT ON COLUMN "public"."event_comments"."thread_id" IS 'Unique identifier for comment thread';



COMMENT ON COLUMN "public"."event_comments"."reply_count" IS 'Number of direct replies to this comment';
...
COMMENT ON COLUMN "public"."photo_comments"."reply_count" IS 'Number of direct replies to this comment';



COMMENT ON COLUMN "public"."photo_comments"."parent_comment_id" IS 'Reference to parent comment for nested replies';



COMMENT ON COLUMN "public"."photo_comments"."comment_depth" IS 'Depth level of comment in thread (0 = top level)';



COMMENT ON COLUMN "public"."photo_comments"."thread_id" IS 'Unique identifier for comment thread';
...
COMMENT ON COLUMN "public"."post_comments"."parent_comment_id" IS 'Reference to parent comment for nested replies';



COMMENT ON COLUMN "public"."post_comments"."comment_depth" IS 'Depth level of comment in thread (0 = top level)';



COMMENT ON COLUMN "public"."post_comments"."thread_id" IS 'Unique identifier for comment thread';



COMMENT ON COLUMN "public"."post_comments"."reply_count" IS 'Number of direct replies to this comment';
...
CREATE INDEX "idx_activity_comments_parent_comment_id" ON "public"."activity_comments" USING "btree" ("parent_comment_id");



CREATE INDEX "idx_activity_comments_reply_count" ON "public"."activity_comments" USING "btree" ("reply_count");



CREATE INDEX "idx_activity_comments_thread_id" ON "public"."activity_comments" USING "btree" ("thread_id");
...
CREATE INDEX "idx_book_club_discussion_comments_parent_comment_id" ON "public"."book_club_discussion_comments" USING "btree" ("parent_comment_id");



CREATE INDEX "idx_book_club_discussion_comments_reply_count" ON "public"."book_club_discussion_comments" USING "btree" ("reply_count");



CREATE INDEX "idx_book_club_discussion_comments_thread_id" ON "public"."book_club_discussion_comments" USING "btree" ("thread_id");
...
CREATE INDEX "idx_comments_reply_count" ON "public"."comments" USING "btree" ("reply_count");
...
CREATE INDEX "idx_discussion_comments_parent_comment_id" ON "public"."discussion_comments" USING "btree" ("parent_comment_id");



CREATE INDEX "idx_discussion_comments_reply_count" ON "public"."discussion_comments" USING "btree" ("reply_count");



CREATE INDEX "idx_discussion_comments_thread_id" ON "public"."discussion_comments" USING "btree" ("thread_id");
...
CREATE INDEX "idx_event_comments_reply_count" ON "public"."event_comments" USING "btree" ("reply_count");



CREATE INDEX "idx_event_comments_thread_id" ON "public"."event_comments" USING "btree" ("thread_id");
...
CREATE INDEX "idx_photo_comments_parent_comment_id" ON "public"."photo_comments" USING "btree" ("parent_comment_id");
...
CREATE INDEX "idx_photo_comments_reply_count" ON "public"."photo_comments" USING "btree" ("reply_count");



CREATE INDEX "idx_photo_comments_thread_id" ON "public"."photo_comments" USING "btree" ("thread_id");
...
CREATE INDEX "idx_post_comments_reply_count" ON "public"."post_comments" USING "btree" ("reply_count");



CREATE INDEX "idx_post_comments_thread_id" ON "public"."post_comments" USING "btree" ("thread_id");
...
CREATE OR REPLACE TRIGGER "trigger_calculate_activity_comment_depth" BEFORE INSERT OR UPDATE ON "public"."activity_comments" FOR EACH ROW EXECUTE FUNCTION "public"."calculate_comment_depth"();



CREATE OR REPLACE TRIGGER "trigger_calculate_book_club_discussion_comment_depth" BEFORE INSERT OR UPDATE ON "public"."book_club_discussion_comments" FOR EACH ROW EXECUTE FUNCTION "public"."calculate_comment_depth"();



CREATE OR REPLACE TRIGGER "trigger_calculate_comment_depth" BEFORE INSERT OR UPDATE ON "public"."comments" FOR EACH ROW EXECUTE FUNCTION "public"."calculate_comment_depth"();



CREATE OR REPLACE TRIGGER "trigger_calculate_discussion_comment_depth" BEFORE INSERT OR UPDATE ON "public"."discussion_comments" FOR EACH ROW EXECUTE FUNCTION "public"."calculate_comment_depth"();



CREATE OR REPLACE TRIGGER "trigger_calculate_event_comment_depth" BEFORE INSERT OR UPDATE ON "public"."event_comments" FOR EACH ROW EXECUTE FUNCTION "public"."calculate_comment_depth"();



CREATE OR REPLACE TRIGGER "trigger_calculate_photo_comment_depth" BEFORE INSERT OR UPDATE ON "public"."photo_comments" FOR EACH ROW EXECUTE FUNCTION "public"."calculate_comment_depth"();



CREATE OR REPLACE TRIGGER "trigger_calculate_post_comment_depth" BEFORE INSERT OR UPDATE ON "public"."post_comments" FOR EACH ROW EXECUTE FUNCTION "public"."calculate_comment_depth"();
...
CREATE OR REPLACE TRIGGER "trigger_update_activity_comment_reply_count" AFTER INSERT OR DELETE ON "public"."activity_comments" FOR EACH ROW EXECUTE FUNCTION "public"."update_comment_reply_count"();



CREATE OR REPLACE TRIGGER "trigger_update_activity_comment_thread_id" BEFORE INSERT OR UPDATE ON "public"."activity_comments" FOR EACH ROW EXECUTE FUNCTION "public"."update_comment_thread_id"();
...
CREATE OR REPLACE TRIGGER "trigger_update_book_club_discussion_comment_reply_count" AFTER INSERT OR DELETE ON "public"."book_club_discussion_comments" FOR EACH ROW EXECUTE FUNCTION "public"."update_comment_reply_count"();



CREATE OR REPLACE TRIGGER "trigger_update_book_club_discussion_comment_thread_id" BEFORE INSERT OR UPDATE ON "public"."book_club_discussion_comments" FOR EACH ROW EXECUTE FUNCTION "public"."update_comment_thread_id"();
...
CREATE OR REPLACE TRIGGER "trigger_update_comment_reply_count" AFTER INSERT OR DELETE ON "public"."comments" FOR EACH ROW EXECUTE FUNCTION "public"."update_comment_reply_count"();



CREATE OR REPLACE TRIGGER "trigger_update_comment_thread_id" BEFORE INSERT OR UPDATE ON "public"."comments" FOR EACH ROW EXECUTE FUNCTION "public"."update_comment_thread_id"();



CREATE OR REPLACE TRIGGER "trigger_update_discussion_comment_reply_count" AFTER INSERT OR DELETE ON "public"."discussion_comments" FOR EACH ROW EXECUTE FUNCTION "public"."update_comment_reply_count"();



CREATE OR REPLACE TRIGGER "trigger_update_discussion_comment_thread_id" BEFORE INSERT OR UPDATE ON "public"."discussion_comments" FOR EACH ROW EXECUTE FUNCTION "public"."update_comment_thread_id"();
...
CREATE OR REPLACE TRIGGER "trigger_update_event_comment_reply_count" AFTER INSERT OR DELETE ON "public"."event_comments" FOR EACH ROW EXECUTE FUNCTION "public"."update_comment_reply_count"();



CREATE OR REPLACE TRIGGER "trigger_update_event_comment_thread_id" BEFORE INSERT OR UPDATE ON "public"."event_comments" FOR EACH ROW EXECUTE FUNCTION "public"."update_comment_thread_id"();
...
CREATE OR REPLACE TRIGGER "trigger_update_photo_comment_reply_count" AFTER INSERT OR DELETE ON "public"."photo_comments" FOR EACH ROW EXECUTE FUNCTION "public"."update_comment_reply_count"();



CREATE OR REPLACE TRIGGER "trigger_update_photo_comment_thread_id" BEFORE INSERT OR UPDATE ON "public"."photo_comments" FOR EACH ROW EXECUTE FUNCTION "public"."update_comment_thread_id"();



CREATE OR REPLACE TRIGGER "trigger_update_post_comment_reply_count" AFTER INSERT OR DELETE ON "public"."post_comments" FOR EACH ROW EXECUTE FUNCTION "public"."update_comment_reply_count"();



CREATE OR REPLACE TRIGGER "trigger_update_post_comment_thread_id" BEFORE INSERT OR UPDATE ON "public"."post_comments" FOR EACH ROW EXECUTE FUNCTION "public"."update_comment_thread_id"();
...
ALTER TABLE ONLY "public"."activity_comments"
    ADD CONSTRAINT "activity_comments_parent_comment_id_fkey" FOREIGN KEY ("parent_comment_id") REFERENCES "public"."activity_comments"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."book_club_discussion_comments"
    ADD CONSTRAINT "book_club_discussion_comments_parent_comment_id_fkey" FOREIGN KEY ("parent_comment_id") REFERENCES "public"."book_club_discussion_comments"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."discussion_comments"
    ADD CONSTRAINT "discussion_comments_parent_comment_id_fkey" FOREIGN KEY ("parent_comment_id") REFERENCES "public"."discussion_comments"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."photo_comments"
    ADD CONSTRAINT "photo_comments_parent_comment_id_fkey" FOREIGN KEY ("parent_comment_id") REFERENCES "public"."photo_comments"("id") ON DELETE CASCADE;
...
GRANT ALL ON FUNCTION "public"."calculate_comment_depth"() TO "anon";
GRANT ALL ON FUNCTION "public"."calculate_comment_depth"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."calculate_comment_depth"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_comment_thread_id"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_comment_thread_id"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_comment_thread_id"() TO "service_role";
