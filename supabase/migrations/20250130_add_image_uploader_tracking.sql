-- Add uploader tracking to images table for enterprise-grade user attribution
...
-- Set default values for any remaining NULL uploader_type
UPDATE public.images 
SET uploader_type = 'user'
WHERE uploader_type IS NULL;

-- For any records where uploader_id is NULL but uploader_type is set, set uploader_type to NULL
UPDATE public.images 
SET uploader_type = NULL
WHERE uploader_id IS NULL AND uploader_type IS NOT NULL;
