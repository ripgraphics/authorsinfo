...
-- This avoids any conflicts with existing functions

-- Create the new working function
CREATE OR REPLACE FUNCTION public.get_user_activities_simple(
    p_user_id uuid,
...
-- Grant permissions
GRANT EXECUTE ON FUNCTION public.get_user_activities_simple TO authenticated;
