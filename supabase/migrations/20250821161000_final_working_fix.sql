-- Final Working Fix - Replace both functions with a single working one
-- This eliminates all the dependency and type mismatch issues

-- Drop both problematic functions
...
-- Create a single, working function
