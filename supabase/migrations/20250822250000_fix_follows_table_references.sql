-- =============================================================================
-- MIGRATION: Fix Follows Table References in Timeline Functions
-- =============================================================================
-- 
-- This migration fixes the follows table references in timeline functions
-- to use the correct table structure with target_type_id instead of target_type.
--
-- =============================================================================

-- Fix the user feed function to use correct follows table structure
