-- Fix badge trigger function - remove progress column reference (doesn't exist in user_badges table)
-- This fixes the error: column "progress" of relation "user_badges" does not exist
...
BEGIN
  ...
  -- NOTE: Removed 'progress' column since it doesn't exist in user_badges table
